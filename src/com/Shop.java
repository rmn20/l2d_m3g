...
final class Shop extends GUIScreen {
   ...
   public Shop(Main main, GameScreen gameScreen, Player player) {
      ...
      this.player = player;
      IniFile var5 = main.getGameText$6783a6a7();
      this.set(main.getFont(), var5.getString("BUY"), var5.getString("BACK"));
      IniFile var4 = IniFile.createFromResource("/setting.txt");
   ...
   protected final void paint(Graphics g) {
      ...
      if(this.isAvailableAidKit()) {
         IniFile var6 = this.main.getGameText$6783a6a7();
      ...
      IniFile var7 = this.main.getGameText$6783a6a7();
