...
public final class Menu extends Selectable {
   ...
   public Menu(Main main) {
      try {
         this.main = main;
         IniFile var2 = main.getGameText$6783a6a7();
         String[] var3 = new String[]{var2.getString("START_GAME"), var2.getString("HELP"), var2.getString("OPTIONS"), var2.getString("EXIT"), "DEBUG MENU"};
   ...
   protected final void onKey5() {
      ...
      if((var1 = this.itemIndex()) == 0) {
         ...
         this.main.setCurrent(new DebugMenu(this.main, this));
      } else {
         this.repaint();
      }
   }
